...
app.get('/login', (req, res) => {
  // REDIRECT goes here
  res.redirect('https://sandbox.owner-panel.high-mobility.com/oauth/new?app_id=50A018C136CF9BB7CE539590&client_id=788ffd97-d820-4066-a3e8-0cd841bc4000&redirect_uri=http://localhost:3000/oauth/authorize')
})
